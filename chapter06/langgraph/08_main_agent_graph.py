...
def create_weather_agent():
    ...
    model = init_chat_model("gpt-5.4-nano-2026-03-17", model_provider="openai").bind_tools([get_weather])
...
def create_main_agent(weather_subgraph):
    ...
    main_model = init_chat_model("gpt-5.4-nano-2026-03-17", model_provider="openai")
...
def main():
    ...
    with open("08_main_agent_graph.png", "wb") as f:
